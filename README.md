...
```
Clone https://github.com/jokerwyt/ClaudeEverywhere to a temp directory (prefer gh if available, otherwise git clone), read the SKILL.md and follow its instructions to set up config sync for this machine.
